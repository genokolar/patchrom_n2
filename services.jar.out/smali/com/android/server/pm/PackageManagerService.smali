...
.field final mFlexAppDir:Ljava/io/File;

.field final mFlexInstallObserver:Landroid/os/FileObserver;
...
.method public constructor <init>(Landroid/content/Context;ZZ)V
    ...
    const-string v3, "/flex/app"

    invoke-direct {v2, v3}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/pm/PackageManagerService;->mFlexAppDir:Ljava/io/File;

    new-instance v2, Lcom/android/server/pm/PackageManagerService$AppDirObserver;

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/pm/PackageManagerService;->mFlexAppDir:Ljava/io/File;
    ...
    iput-object v2, v0, Lcom/android/server/pm/PackageManagerService;->mFlexInstallObserver:Landroid/os/FileObserver;

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/pm/PackageManagerService;->mFlexInstallObserver:Landroid/os/FileObserver;
...
.method private deletePackageLI(Ljava/lang/String;ZILcom/android/server/pm/PackageManagerService$PackageRemovedInfo;Z)Z
    ...
    const-string v2, "-deletePackageLI-"
...
.method private queryActivity(Ljava/lang/String;Ljava/lang/String;)Landroid/content/pm/PackageParser$Activity;
    .locals 7
    .parameter "pkgName"
    ...
    const-string v6, "th avtivity name: "
    ...
    const-string v6, "queryActivity: not find activity->"
...
.method private unloadMediaPackages(Ljava/util/HashMap;[IZ)V
    ...
    const-string v4, "PackageManagerTrying to unload pkg : "
...
.method private updateExternalMediaStatusInner(ZZ)V
    ...
    const-string v22, "PackageManager Unloading packages111"
...
.method public setActivityLable(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 5
    .parameter "packageName"
    .parameter "activityName"
    .parameter "newLable"
    ...
    const-string v4, "setActivityLable error:Someone is null!"
    ...
    :cond_2
    invoke-direct {p0, p1, p2}, Lcom/android/server/pm/PackageManagerService;->queryActivity(Ljava/lang/String;Ljava/lang/String;)Landroid/content/pm/PackageParser$Activity;
    ...
    iput-object p3, v2, Landroid/content/pm/ActivityInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;

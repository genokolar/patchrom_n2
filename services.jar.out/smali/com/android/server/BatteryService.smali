...
# instance fields
.field private disableCall:Z

.field private disableCamera:Z
...
.field private mChargingVoltage:I
...
.field private mLastChargingVoltage:I
...
.field private mLowBatteryStopCallOutLevel:I

.field private mLowBatteryStopCallOutLevelForCharge:I

.field private mLowBatteryStopCameraLevel:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->disableCall:Z

    iput-boolean v1, p0, Lcom/android/server/BatteryService;->disableCamera:Z
    ...
    iput v0, p0, Lcom/android/server/BatteryService;->mLowBatteryStopCallOutLevel:I
    ...
    iput v0, p0, Lcom/android/server/BatteryService;->mLowBatteryStopCallOutLevelForCharge:I
    ...
    iput v0, p0, Lcom/android/server/BatteryService;->mLowBatteryStopCameraLevel:I
...
.method private BatteryCharge()Z
    .locals 3
...
.method private final disableCallIfLowPower()V
    .locals 5
    ...
    const-string v2, "disableCallIfLowPower----BatteryCharge:"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    invoke-direct {p0}, Lcom/android/server/BatteryService;->BatteryCharge()Z
    ...
    const-string v2, "  mLowBatteryStopCallOutLevelForCharge"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/server/BatteryService;->mLowBatteryStopCallOutLevelForCharge:I

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string v2, "  mLowBatteryStopCallOutLevel"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/server/BatteryService;->mLowBatteryStopCallOutLevel:I

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string v2, "   disableCall:  "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p0, Lcom/android/server/BatteryService;->disableCall:Z
    ...
    iget v1, p0, Lcom/android/server/BatteryService;->mLowBatteryStopCallOutLevelForCharge:I

    if-gt v0, v1, :cond_1

    iget-boolean v0, p0, Lcom/android/server/BatteryService;->disableCall:Z

    if-nez v0, :cond_1

    const-string v0, "battery.low.disable-call"

    const-string v1, "true"

    invoke-static {v0, v1}, Landroid/os/SystemProperties;->set(Ljava/lang/String;Ljava/lang/String;)V

    iput-boolean v4, p0, Lcom/android/server/BatteryService;->disableCall:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->disableCall:Z
    ...
    iget v1, p0, Lcom/android/server/BatteryService;->mLowBatteryStopCallOutLevel:I
...
.method private final disableCameraIfLowPower()V
    .locals 2

    .prologue
    iget v0, p0, Lcom/android/server/BatteryService;->mBatteryLevel:I

    iget v1, p0, Lcom/android/server/BatteryService;->mLowBatteryStopCameraLevel:I

    if-gt v0, v1, :cond_1

    iget-boolean v0, p0, Lcom/android/server/BatteryService;->disableCamera:Z

    if-nez v0, :cond_1

    const-string v0, "battery.low.disable-camera"
    ...
    iput-boolean v0, p0, Lcom/android/server/BatteryService;->disableCamera:Z
...
.method private processValues()V
    ...
    invoke-direct {p0}, Lcom/android/server/BatteryService;->disableCallIfLowPower()V

    invoke-direct {p0}, Lcom/android/server/BatteryService;->disableCameraIfLowPower()V
    ...
    iget v0, p0, Lcom/android/server/BatteryService;->mChargingVoltage:I

    iget v1, p0, Lcom/android/server/BatteryService;->mLastChargingVoltage:I
    ...
    iget-object v3, p0, Lcom/android/server/BatteryService;->mManufacturer:Ljava/lang/String;
    ...
    iput v0, p0, Lcom/android/server/BatteryService;->mLastChargingVoltage:I
...
.method private final sendIntent()V
    ...
    const-string v2, "charging_voltage"

    iget v3, p0, Lcom/android/server/BatteryService;->mChargingVoltage:I
    ...
    iget v4, p0, Lcom/android/server/BatteryService;->mBatteryCurrent:I

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v4, " charging voltage: "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lcom/android/server/BatteryService;->mChargingVoltage:I
    ...
    iget-object v4, p0, Lcom/android/server/BatteryService;->mManufacturer:Ljava/lang/String;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget v1, p0, Lcom/android/server/BatteryService;->mBatteryCurrent:I
    ...
    const-string v1, "  charging voltage:"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v1, p0, Lcom/android/server/BatteryService;->mChargingVoltage:I
    ...
    iget-object v1, p0, Lcom/android/server/BatteryService;->mManufacturer:Ljava/lang/String;

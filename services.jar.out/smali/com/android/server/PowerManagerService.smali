...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/PowerManagerService$TouchEventTimeoutTask;,
...
.field static final ANIM_STEPS:I = 0xc

.field static final AUTOBRIGHTNESS_ANIM_STEPS:I = 0x18
...
.field private static final LIGHT_SENSOR_RATE_FOR_BBL:I = 0xc350
...
.field private mLightSensorTempEnabled:Z
...
.field private mTouchEventTimeoutTask:Lcom/android/server/PowerManagerService$TouchEventTimeoutTask;
...
.method constructor <init>()V
    ...
    iput-boolean v4, p0, Lcom/android/server/PowerManagerService;->mLightSensorTempEnabled:Z
    ...
    iput v2, p0, Lcom/android/server/PowerManagerService;->mSampleRate:I

    const/16 v2, 0x10

    iput v2, p0, Lcom/android/server/PowerManagerService;->mAnimationSetting:I

    new-instance v2, Lcom/android/server/PowerManagerService$TouchEventTimeoutTask;

    invoke-direct {v2, p0, v7}, Lcom/android/server/PowerManagerService$TouchEventTimeoutTask;-><init>(Lcom/android/server/PowerManagerService;Lcom/android/server/PowerManagerService$1;)V

    iput-object v2, p0, Lcom/android/server/PowerManagerService;->mTouchEventTimeoutTask:Lcom/android/server/PowerManagerService$TouchEventTimeoutTask;
...
.method static synthetic access$2700(Lcom/android/server/PowerManagerService;)V
    ...
    .prologue
    invoke-direct {p0}, Lcom/android/server/PowerManagerService;->handleTempSensorValues()V
...
.method static synthetic access$7300(Lcom/android/server/PowerManagerService;)Z
    ...
    .prologue
    iget-boolean v0, p0, Lcom/android/server/PowerManagerService;->mLightSensorTempEnabled:Z
...
.method static synthetic access$7500(Lcom/android/server/PowerManagerService;IZ)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private enableLightSensorLocked(Z)V
    ...
    iget-boolean v3, p0, Lcom/android/server/PowerManagerService;->mLightSensorTempEnabled:Z
    ...
    :goto_0
    iput v3, p0, Lcom/android/server/PowerManagerService;->mSampleRate:I
    ...
    iget v6, p0, Lcom/android/server/PowerManagerService;->mSampleRate:I
...
.method private handleLightSensorValue(IZ)V
    ...
    iget v7, p0, Lcom/android/server/PowerManagerService;->mSampleRate:I
...
.method private handleTempSensorValues()V
    .locals 5

    .prologue
    iget-object v3, p0, Lcom/android/server/PowerManagerService;->mHandler:Landroid/os/Handler;

    iget-object v4, p0, Lcom/android/server/PowerManagerService;->mTouchEventTimeoutTask:Lcom/android/server/PowerManagerService$TouchEventTimeoutTask;
    ...
    iget-object v3, p0, Lcom/android/server/PowerManagerService;->mLightsService:Lcom/android/server/LightsService;

    invoke-virtual {v3}, Lcom/android/server/LightsService;->turnOnButtonLightOneShot()V
    ...
    invoke-direct {p0}, Lcom/android/server/PowerManagerService;->resetTempSensorVar()V
...
.method private resetTempSensorVar()V
    .locals 3
    ...
    iget-object v1, p0, Lcom/android/server/PowerManagerService;->mTouchEventTimeoutTask:Lcom/android/server/PowerManagerService$TouchEventTimeoutTask;
    ...
    iget-object v1, p0, Lcom/android/server/PowerManagerService;->mLightListener:Landroid/hardware/SensorEventListener;
    ...
    :cond_1
    iput-boolean v2, p0, Lcom/android/server/PowerManagerService;->mLightSensorTempEnabled:Z
...
.method private userActivity(JJZIZZ)V
    ...
    :try_start_4
    iget-boolean v1, p0, Lcom/android/server/PowerManagerService;->mDoneBooting:Z

    if-eqz v1, :cond_b

    iget-object v1, p0, Lcom/android/server/PowerManagerService;->mLightsService:Lcom/android/server/LightsService;

    invoke-virtual {v1}, Lcom/android/server/LightsService;->turnOnButtonLightOneShot()V
...
.method public enablePowerKeyInProximitySensor()V
    .locals 1
...
.method public setLEDLight(I)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/LightsService;->getLight(I)Lcom/android/server/LightsService$Light;

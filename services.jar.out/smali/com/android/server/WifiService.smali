...
.field private static final ICON_NETWORKS_AVAILABLE:I = 0x1080512
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v7, p0, Lcom/android/server/WifiService;->wifiAddress:Ljava/lang/String;
...
.method public resetWifiMAC()Z
    ...
    invoke-virtual {v5}, Landroid/telephony/TelephonyManager;->getWifiAddr()Ljava/lang/String;

    move-result-object v5

    iput-object v5, p0, Lcom/android/server/WifiService;->wifiAddress:Ljava/lang/String;

    iget-object v5, p0, Lcom/android/server/WifiService;->wifiAddress:Ljava/lang/String;

    if-nez v5, :cond_4

    new-instance v2, Ljava/io/File;

    const-string v5, "/data/misc/encryption/wifidaemonaddr"
    ...
    const-string v7, "resetWifiMAC()-wifiMAC="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, p0, Lcom/android/server/WifiService;->wifiAddress:Ljava/lang/String;
    ...
    invoke-static {v5}, Landroid/net/wifi/WifiNative;->setWifiMAC(Ljava/lang/String;)Z
    ...
    const-string v8, "resetWifiMAC() error="

...
.field public static final CONTENT_SMARTDIAL_FILTER_URI:Landroid/net/Uri; = null

.field public static final CONTENT_SMARTDIAL_URI:Landroid/net/Uri; = null

.field public static final CONTENT_STROKEDIAL_FILTER_URI:Landroid/net/Uri; = null

.field public static final CONTENT_STROKEDIAL_URI:Landroid/net/Uri; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/provider/ContactsContract$CommonDataKinds$Phone;->CONTENT_SMARTDIAL_URI:Landroid/net/Uri;

    sget-object v0, Landroid/provider/ContactsContract$CommonDataKinds$Phone;->CONTENT_SMARTDIAL_URI:Landroid/net/Uri;
    ...
    sput-object v0, Landroid/provider/ContactsContract$CommonDataKinds$Phone;->CONTENT_SMARTDIAL_FILTER_URI:Landroid/net/Uri;

    sget-object v0, Landroid/provider/ContactsContract$Data;->CONTENT_URI:Landroid/net/Uri;

    const-string v1, "strokedial"

    invoke-static {v0, v1}, Landroid/net/Uri;->withAppendedPath(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    sput-object v0, Landroid/provider/ContactsContract$CommonDataKinds$Phone;->CONTENT_STROKEDIAL_URI:Landroid/net/Uri;

    sget-object v0, Landroid/provider/ContactsContract$CommonDataKinds$Phone;->CONTENT_STROKEDIAL_URI:Landroid/net/Uri;
    ...
    sput-object v0, Landroid/provider/ContactsContract$CommonDataKinds$Phone;->CONTENT_STROKEDIAL_FILTER_URI:Landroid/net/Uri;

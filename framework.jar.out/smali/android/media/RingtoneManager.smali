...
# static fields
.field public static final ACTION_CELLON_RINGTONE_PICKER:Ljava/lang/String; = "android.intent.action.CELLON_RINGTONE_PICKER"
...
.field public static final EXTRA_RINGTONE_SHOW_LIBRARY_MUSIC:Ljava/lang/String; = "android.intent.extra.ringtone.SHOW_LIBRARY_MUSIC"
...
.method private getSmallSizeAudioCursor()Landroid/database/Cursor;
    .locals 8
    ...
    const-string v1, "FLEX_ID_MMS_SIZE_LIMIT"

    const/16 v2, 0x12c

    invoke-static {v0, v1, v2}, Landroid/cellonflex/CellonFlex;->getInt(Ljava/lang/String;Ljava/lang/String;I)I
...
# virtual methods
.method public getAudioCursor()Landroid/database/Cursor;
    .locals 5
    ...
    invoke-direct {p0}, Landroid/media/RingtoneManager;->getSmallSizeAudioCursor()Landroid/database/Cursor;
...
.method public setPreviousRingtone(Landroid/media/Ringtone;)V
    .locals 0
    .parameter "ringtone"

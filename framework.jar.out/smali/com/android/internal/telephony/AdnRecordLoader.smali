...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v2, " EVENT_ADN_LOAD_DONE load failed"
    ...
    const-string v2, "EVENT_EXT_RECORD_LOAD_DONE load failed"
    ...
    const-string v2, "EVENT_ADN_LOAD_ALL_DONE load failed"
...
.method public loadFromEF(IIILandroid/os/Message;)V
    ...
    invoke-virtual {v0, p1, p3, v1}, Lcom/android/internal/telephony/IccFileHandler;->loadMsisdnTransparent(IILandroid/os/Message;)V
...
.method public updateEF(Lcom/android/internal/telephony/AdnRecord;Lcom/android/internal/telephony/AdnRecordCache;IIILjava/lang/String;Landroid/os/Message;)V
    .locals 6
    .parameter "adn"
    .parameter "adnCache"
    .parameter "ef"
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/android/internal/telephony/AdnRecordCache;->getSimRecordLength()I

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p2}, Lcom/android/internal/telephony/AdnRecordCache;->getSimRecordMaxSize()I
    ...
    invoke-virtual {v0, p3, v1}, Lcom/android/internal/telephony/IccFileHandler;->getEFLinearRecordSize(ILandroid/os/Message;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/internal/telephony/AdnRecord;->build3GAdnString(I)[B
    ...
    iput v0, p0, Lcom/android/internal/telephony/AdnRecordLoader;->pendingExtLoads:I

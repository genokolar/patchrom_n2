...
# static fields
.field private static final BT_MAC_ADDRESS:Ljava/lang/String; = "/data/misc/encryption/btdaemonaddr"
...
.field private static final WIFI_MAC_ADDRESS:Ljava/lang/String; = "/data/misc/encryption/wifidaemonaddr"

.field private static debugSocket:Landroid/net/LocalServerSocket;

.field private static testSocket:Landroid/net/LocalServerSocket;


# instance fields
.field private BtAddr:Ljava/lang/String;

.field private CellonMatNv:Ljava/lang/String;

.field private WifiAddr:Ljava/lang/String;
...
.field protected final nvmLock:Ljava/lang/Object;

.field set_NV_Resut:I

.field testPortThread:Ljava/lang/Thread;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/PhoneNotifier;Z)V
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->nvmLock:Ljava/lang/Object;
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->CellonMatNv:Ljava/lang/String;

    const/4 v1, 0x0

    iput v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->set_NV_Resut:I

    iput-boolean v5, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->isWait:Z
    ...
    invoke-interface {v1, v5}, Lcom/android/internal/telephony/CommandsInterface;->setPhoneType(I)V
    ...
    invoke-interface {v1, p0, v2, v4}, Lcom/android/internal/telephony/CommandsInterface;->setOnUSSD(Landroid/os/Handler;ILjava/lang/Object;)V

    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mCM:Lcom/android/internal/telephony/CommandsInterface;

    const/4 v2, 0x2

    invoke-interface {v1, p0, v2, v4}, Lcom/android/internal/telephony/CommandsInterface;->setOnSuppServiceNotification(Landroid/os/Handler;ILjava/lang/Object;)V

    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSST:Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;

    const/16 v2, 0x13

    invoke-virtual {v1, p0, v2, v4}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->registerForNetworkAttached(Landroid/os/Handler;ILjava/lang/Object;)V

    :try_start_0
    new-instance v1, Landroid/net/LocalServerSocket;

    const-string v2, "com.android.internal.telephony.debug"

    invoke-direct {v1, v2}, Landroid/net/LocalServerSocket;-><init>(Ljava/lang/String;)V

    sput-object v1, Lcom/android/internal/telephony/gsm/GSMPhone;->debugSocket:Landroid/net/LocalServerSocket;

    new-instance v1, Ljava/lang/Thread;

    new-instance v2, Lcom/android/internal/telephony/gsm/GSMPhone$1;

    invoke-direct {v2, p0}, Lcom/android/internal/telephony/gsm/GSMPhone$1;-><init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V

    const-string v3, "GSMPhone reset radio"

    invoke-direct {v1, v2, v3}, Ljava/lang/Thread;-><init>(Ljava/lang/Runnable;Ljava/lang/String;)V

    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->debugPortThread:Ljava/lang/Thread;

    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->debugPortThread:Ljava/lang/Thread;
    ...
    const-string v2, "com.android.internal.telephony.test"

    invoke-direct {v1, v2}, Landroid/net/LocalServerSocket;-><init>(Ljava/lang/String;)V

    sput-object v1, Lcom/android/internal/telephony/gsm/GSMPhone;->testSocket:Landroid/net/LocalServerSocket;
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->testPortThread:Ljava/lang/Thread;

    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->testPortThread:Ljava/lang/Thread;
    ...
    const-string v2, "Failure to open com.android.internal.telephony.debug socket"
...
.method private UpdateFileContent(Ljava/lang/String;Ljava/lang/String;Z)Z
    .locals 11
    ...
    const-string v10, "UpdateFileContent()"
    ...
    .local v5, myFilePath:Ljava/io/File;
    ...
    .end local v5           #myFilePath:Ljava/io/File;
    :cond_1
    :goto_0
    return v7

    .restart local v2       #filePath:Ljava/lang/String;
    .restart local v5       #myFilePath:Ljava/io/File;
    :cond_2
    ...
    invoke-direct {v4, v5, p3}, Ljava/io/FileOutputStream;-><init>(Ljava/io/File;Z)V
    ...
    const-string v10, "UpdateFileContent() error="
...
.method static synthetic access$000()Landroid/net/LocalServerSocket;
    .locals 1

    .prologue
    sget-object v0, Lcom/android/internal/telephony/gsm/GSMPhone;->debugSocket:Landroid/net/LocalServerSocket;
...
.method static synthetic access$100()Landroid/net/LocalServerSocket;
    ...
    .prologue
    sget-object v0, Lcom/android/internal/telephony/gsm/GSMPhone;->testSocket:Landroid/net/LocalServerSocket;
...
.method private notifyPending(Landroid/os/AsyncResult;)V
    ...
    const-string v1, "enter notifyPending start"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const-string v0, "GSM"

    const-string v1, "enter notifyPending"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->nvmLock:Ljava/lang/Object;

    invoke-virtual {v0}, Ljava/lang/Object;->notifyAll()V

    const-string v0, "GSM"

    const-string v1, "out  notifyPending"
...
.method public getBtAddr()Ljava/lang/String;
    ...
    .prologue
    iget-object v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->BtAddr:Ljava/lang/String;
...
.method public getMatCellonNV(I)Ljava/lang/String;
    ...
    const-string v2, "getMatCellonNV in GSMPhone "
    ...
    invoke-interface {v1, p1, v2}, Lcom/android/internal/telephony/CommandsInterface;->getNVForCellon(ILandroid/os/Message;)V

    iget-object v2, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->nvmLock:Ljava/lang/Object;
    ...
    const-string v3, "enter getMatCellonNV  synchronized"

    invoke-static {v1, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->waitForResult()V

    const-string v1, "GSM"

    const-string v3, "out getMatCellonNV  synchronized"
    ...
    const-string v3, "getMatCellonNV ..CellonMatNv="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->CellonMatNv:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->CellonMatNv:Ljava/lang/String;
...
.method public getWifiAddr()Ljava/lang/String;
    ...
    .prologue
    iget-object v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->WifiAddr:Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-interface {v9, v10}, Lcom/android/internal/telephony/CommandsInterface;->getWIFIADDR(Landroid/os/Message;)V
    ...
    invoke-interface {v9, v10}, Lcom/android/internal/telephony/CommandsInterface;->getBTADDR(Landroid/os/Message;)V
    ...
    const-string v11, "jack get imei ="
    ...
    iput-object v9, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->BtAddr:Ljava/lang/String;

    const-string v9, "/data/misc/encryption/btdaemonaddr"

    iget-object v10, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->BtAddr:Ljava/lang/String;

    invoke-direct {p0, v9, v10, v11}, Lcom/android/internal/telephony/gsm/GSMPhone;->UpdateFileContent(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string v11, "BtAddr ="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->BtAddr:Ljava/lang/String;
    ...
    iput-object v9, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->WifiAddr:Ljava/lang/String;

    const-string v9, "/data/misc/encryption/wifidaemonaddr"

    iget-object v10, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->WifiAddr:Ljava/lang/String;
    ...
    const-string v11, "WifiAddr ="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v11, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->WifiAddr:Ljava/lang/String;
    ...
    .restart local v0       #ar:Landroid/os/AsyncResult;
    iget-object v10, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->nvmLock:Ljava/lang/Object;
    ...
    iput-object v9, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->CellonMatNv:Ljava/lang/String;
    ...
    const-string v12, "EVENT_GET_CELLON_NV_DONE ..CellonMatNv="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v12, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->CellonMatNv:Ljava/lang/String;
    ...
    iput-boolean v9, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->isWait:Z

    const-string v9, "GSM"

    const-string v11, "EVENT_GET_CELLON_NV_DONE notifyPending(ar);"

    invoke-static {v9, v11}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v9, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->nvmLock:Ljava/lang/Object;
    ...
    iput v9, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->set_NV_Resut:I
    ...
    const-string v12, "EVENT_SET_CELLON_NV_DONE ..sellonMatNv="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget v12, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->set_NV_Resut:I
    ...
    iget-object v12, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mIccRecords:Lcom/android/internal/telephony/IccRecords;
...
.method public setMatCellonNV(ILjava/lang/String;)I
    ...
    invoke-interface {v1, p1, p2, v2}, Lcom/android/internal/telephony/CommandsInterface;->setNVForCellon(ILjava/lang/String;Landroid/os/Message;)V
    ...
    const-string v3, "enter setMatCellonNV  synchronized"
    ...
    const-string v3, "out setMatCellonNV  synchronized"
    ...
    iget v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->set_NV_Resut:I
...
.method public setPowerModemOff()V
    ...
    invoke-interface {v0, v1}, Lcom/android/internal/telephony/CommandsInterface;->Request_Modem_Off(Landroid/os/Message;)V
...
.method protected waitForResult()V
    ...
    .prologue
    :goto_0
    iget-boolean v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->isWait:Z

    if-eqz v1, :cond_0

    :try_start_0
    iget-object v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->nvmLock:Ljava/lang/Object;
    ...
    const-string v2, "interrupted while trying to update by search"
    ...
    iput-boolean v1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->isWait:Z

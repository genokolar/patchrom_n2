...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;
    }
.end annotation
...
.field private mRecordSize:Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;
...
.method public constructor <init>(Lcom/android/internal/telephony/IccFileHandler;)V
    ...
    new-instance v0, Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;

    invoke-direct {v0, p0}, Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;-><init>(Lcom/android/internal/telephony/AdnRecordCache;)V

    iput-object v0, p0, Lcom/android/internal/telephony/AdnRecordCache;->mRecordSize:Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;
...
.method getSimRecordLength()I
    .locals 1

    .prologue
    iget-object v0, p0, Lcom/android/internal/telephony/AdnRecordCache;->mRecordSize:Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;

    iget v0, v0, Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;->simRecordLength:I

    return v0
.end method

.method getSimRecordMaxSize()I
    .locals 1

    .prologue
    iget-object v0, p0, Lcom/android/internal/telephony/AdnRecordCache;->mRecordSize:Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;

    iget v0, v0, Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;->simRecordMaxSize:I
...
.method public requestLoadAllAdnLike(IILandroid/os/Message;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/AdnRecordCache;->getRecordsIfLoaded(I)Ljava/util/ArrayList;
...
.method public reset()V
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;->reset()V
...
.method setRecordSize(II)V
    .locals 3
    .parameter "simRecordLength"
    .parameter "simRecordMaxSize"
    ...
    const-string v2, "RecordSizeStruct simRecordLength="
    ...
    const-string v2, "RecordSizeStruct simRecordMaxSize="
    ...
    iput p1, v0, Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;->simRecordLength:I

    iget-object v0, p0, Lcom/android/internal/telephony/AdnRecordCache;->mRecordSize:Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;

    iput p2, v0, Lcom/android/internal/telephony/AdnRecordCache$RecordSizeStruct;->simRecordMaxSize:I
...
.method public updateAdnByIndex(ILcom/android/internal/telephony/AdnRecord;ILjava/lang/String;Landroid/os/Message;)V
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/android/internal/telephony/AdnRecordLoader;->updateEF(Lcom/android/internal/telephony/AdnRecord;Lcom/android/internal/telephony/AdnRecordCache;IIILjava/lang/String;Landroid/os/Message;)V
...
.method public updateAdnBySearch(ILcom/android/internal/telephony/AdnRecord;Lcom/android/internal/telephony/AdnRecord;Ljava/lang/String;Landroid/os/Message;)V
    ...
    .local v12, oldAdnList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/AdnRecord;>;"
    const/16 v1, 0x4f30
    ...
    :try_start_0
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/AdnRecordCache;->getRecordsIfLoaded(I)Ljava/util/ArrayList;
    :try_end_0
    ...
    const-string v1, "brewter"

    const-string v2, "***AdnRecordCache.java  updateAdnBySearch index == -1***"
    ...
    const-string v2, "***AdnRecordCache.java  updateAdnBySearch pendingResponse != null***"
    ...
    invoke-virtual {p0, v2, p1, v6, v0}, Lcom/android/internal/telephony/AdnRecordCache;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual/range {v1 .. v8}, Lcom/android/internal/telephony/AdnRecordLoader;->updateEF(Lcom/android/internal/telephony/AdnRecord;Lcom/android/internal/telephony/AdnRecordCache;IIILjava/lang/String;Landroid/os/Message;)V

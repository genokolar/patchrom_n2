...
.field public static final GET_DATA_ST_WHEN_SCREEN_ON:I = 0x42021
...
# instance fields
.field private Context1:Landroid/content/Context;

.field private dataEnabled:[Z

.field private data_status:I

.field private enabledCount:I

.field private isPowerSavingModeActivated:Z

.field private isScreenOnGetPDPState:Z
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    iput-boolean v9, p0, Lcom/android/internal/telephony/DataConnectionTracker;->isPowerSavingModeActivated:Z

    iput v9, p0, Lcom/android/internal/telephony/DataConnectionTracker;->enabledCount:I

    iput v9, p0, Lcom/android/internal/telephony/DataConnectionTracker;->data_status:I

    iput-boolean v9, p0, Lcom/android/internal/telephony/DataConnectionTracker;->isScreenOnGetPDPState:Z
...
.method static synthetic access$002(Lcom/android/internal/telephony/DataConnectionTracker;Landroid/content/Context;)Landroid/content/Context;
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    iput-object p1, p0, Lcom/android/internal/telephony/DataConnectionTracker;->Context1:Landroid/content/Context;

    return-object p1
.end method

.method static synthetic access$100(Lcom/android/internal/telephony/DataConnectionTracker;)Z
    .locals 1
    .parameter "x0"

    .prologue
    iget-boolean v0, p0, Lcom/android/internal/telephony/DataConnectionTracker;->isPowerSavingModeActivated:Z

    return v0
.end method

.method static synthetic access$202(Lcom/android/internal/telephony/DataConnectionTracker;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    iput-boolean p1, p0, Lcom/android/internal/telephony/DataConnectionTracker;->isScreenOnGetPDPState:Z

    return p1
.end method

.method static synthetic access$300(Lcom/android/internal/telephony/DataConnectionTracker;)V
    .locals 0
    .parameter "x0"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v9, "jack"

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "GET_DATA_ST_WHEN_SCREEN_ON ..data_status="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget v12, p0, Lcom/android/internal/telephony/DataConnectionTracker;->data_status:I
    ...
    iget-boolean v9, p0, Lcom/android/internal/telephony/DataConnectionTracker;->isScreenOnGetPDPState:Z

    if-eqz v9, :cond_0

    iget v9, p0, Lcom/android/internal/telephony/DataConnectionTracker;->data_status:I

    if-nez v9, :cond_0

    iput-boolean v8, p0, Lcom/android/internal/telephony/DataConnectionTracker;->isScreenOnGetPDPState:Z

    iget-object v9, p0, Lcom/android/internal/telephony/DataConnectionTracker;->Context1:Landroid/content/Context;
    ...
    invoke-virtual {v3, v10}, Landroid/net/ConnectivityManager;->setMobileDataEnabled(Z)V

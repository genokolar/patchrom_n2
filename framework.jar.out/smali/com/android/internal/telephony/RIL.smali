...
.field static final DEFAULT_RESET_SOCKET_TIMEOUT_TIMES:I = 0xf

.field static final DEFAULT_SEND_TIMEOUT:I = 0x4e20

.field private static final DEFAULT_WAKE_LOCK_TIMEOUT:I = 0xea60

.field static final EVENT_SEND:I = 0x1

.field static final EVENT_SEND_TIMEOUT:I = 0x3
...
.field static mContTimeoutCnt:I

.field static mRejectCallFlag:Z

.field static mResetSocketFlag:Z
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/internal/telephony/RIL;->mContTimeoutCnt:I

    sput-boolean v0, Lcom/android/internal/telephony/RIL;->mResetSocketFlag:Z

    sput-boolean v0, Lcom/android/internal/telephony/RIL;->mRejectCallFlag:Z
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    iput-boolean v6, p0, Lcom/android/internal/telephony/RIL;->isLoopTest:Z
...
.method private declared-synchronized InitOrCalcSendTimeout(Z)V
    .locals 2
    .parameter "blInit"
    ...
    :cond_1
    :try_start_1
    sget v0, Lcom/android/internal/telephony/RIL;->mContTimeoutCnt:I
...
.method private RejectCallReqestWhenTimeout(Lcom/android/internal/telephony/RILRequest;)Z
    .locals 8
    .parameter "rr"
    ...
    sget v3, Lcom/android/internal/telephony/RIL;->mContTimeoutCnt:I
    ...
    :sswitch_0
    sput-boolean v7, Lcom/android/internal/telephony/RIL;->mRejectCallFlag:Z

    :sswitch_1
    sget-boolean v3, Lcom/android/internal/telephony/RIL;->mRejectCallFlag:Z
    ...
    const-string v5, "RejectCallReqestWhenTimeout: mContTimeoutCnt="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/internal/telephony/RIL;->mContTimeoutCnt:I
    ...
    invoke-virtual {p1, v7, v3}, Lcom/android/internal/telephony/RILRequest;->onError(ILjava/lang/Object;)V
    ...
    sput-boolean v6, Lcom/android/internal/telephony/RIL;->mRejectCallFlag:Z
    ...
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/RIL;->RejectCallReqestWhenTimeout(Lcom/android/internal/telephony/RILRequest;)Z
...
.method private declared-synchronized ReleaseSendTimeout()V
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/RIL$RILSender;->hasMessages(I)Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/RIL$RILSender;->removeMessages(I)V

    :cond_0
    const/4 v0, 0x1

    invoke-direct {p0, v0}, Lcom/android/internal/telephony/RIL;->InitOrCalcSendTimeout(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private declared-synchronized RequestSendTimeout()V
    .locals 4
    ...
    invoke-virtual {v1, v2}, Lcom/android/internal/telephony/RIL$RILSender;->hasMessages(I)Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/internal/telephony/RIL$RILSender;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v1, v0, v2, v3}, Lcom/android/internal/telephony/RIL$RILSender;->sendMessageDelayed(Landroid/os/Message;J)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private declared-synchronized ResetSocket()V
    .locals 4
    ...
    const-string v3, "ResetSocket ex: "
...
.method static synthetic access$300(Lcom/android/internal/telephony/RIL;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/RIL;->InitOrCalcSendTimeout(Z)V
...
.method static synthetic access$400(Lcom/android/internal/telephony/RIL;)V
    ...
    .prologue
    invoke-direct {p0}, Lcom/android/internal/telephony/RIL;->ResetSocket()V

    return-void
.end method

.method static synthetic access$500(Lcom/android/internal/telephony/RIL;)V
    .locals 0
    .parameter "x0"

    .prologue
    invoke-direct {p0}, Lcom/android/internal/telephony/RIL;->RequestSendTimeout()V
...
.method private processResponse(Landroid/os/Parcel;)V
    ...
    invoke-direct {p0}, Lcom/android/internal/telephony/RIL;->ReleaseSendTimeout()V
...
.method private processSolicited(Landroid/os/Parcel;)V
    ...
    :pswitch_73
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/RIL;->responseEngMode(Landroid/os/Parcel;)Ljava/lang/Object;
    :try_end_2
...
.method private processUnsolicited(Landroid/os/Parcel;)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/RIL;->responsePbReady()Ljava/lang/Object;
...
.method static requestToString(I)Ljava/lang/String;
    ...
    :pswitch_27
    const-string v0, "RIL_REQUEST_GET_CELLON_BTADDR"

    goto :goto_0

    :pswitch_28
    const-string v0, "RIL_REQUEST_GET_CELLON_WIFIADDR"

    goto :goto_0

    :pswitch_29
    const-string v0, "RIL_REQUEST_READ_CELLON_NV"

    goto :goto_0

    :pswitch_2a
    const-string v0, "RIL_REQUEST_WRITE_CELLON_NV"
    ...
    :pswitch_3f
    const-string v0, "RIL_REQUEST_GET_PDP_STATUS"
...
.method private responseIccCardStatus(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    const-string v4, "KYLE"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "get_sim_pin_state ca.pin1_num_retries="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, v0, Lcom/android/internal/telephony/IccCardApplication;->pin1_num_retries:I
    ...
    const-string v6, "get_sim_pin_state ca.pin2_num_retries="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, v0, Lcom/android/internal/telephony/IccCardApplication;->pin2_num_retries:I
    ...
    const-string v6, "get_sim_pin_state ca.puk1_num_retries="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, v0, Lcom/android/internal/telephony/IccCardApplication;->puk1_num_retries:I
    ...
    const-string v6, "get_sim_pin_state ca.puk2_num_retries="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget v6, v0, Lcom/android/internal/telephony/IccCardApplication;->puk2_num_retries:I
...
.method private responsePbReady()Ljava/lang/Object;
    .locals 2

    .prologue
    const-string v0, "ril"

    const-string v1, "pbready"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {p0}, Lcom/android/internal/telephony/RIL;->sendPbReadyIntent()V
...
.method static responseToString(I)Ljava/lang/String;
    ...
    :pswitch_24
    const-string v0, "UNSOL_RIL_PB_READY"
...
.method private send(Lcom/android/internal/telephony/RILRequest;)V
    ...
    iget-boolean v1, p0, Lcom/android/internal/telephony/RIL;->isLoopTest:Z
    ...
    invoke-virtual {p1, v4, v3}, Lcom/android/internal/telephony/RILRequest;->onError(ILjava/lang/Object;)V
    ...
    :cond_1
    sget-boolean v1, Lcom/android/internal/telephony/RIL;->mResetSocketFlag:Z
    ...
    :cond_2
    sget v1, Lcom/android/internal/telephony/RIL;->mContTimeoutCnt:I
    ...
    const-string v3, "send command RIL_REQUEST_RESET_RADIO: mContTimeoutCnt="
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/telephony/RIL;->InitOrCalcSendTimeout(Z)V
    ...
    invoke-virtual {v1, v4, p1}, Lcom/android/internal/telephony/RIL$RILSender;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method private sendScreenState_ext(Z)V
    .locals 4
    .parameter "on"
    ...
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/RIL;->send_ext(Lcom/android/internal/telephony/RILRequest;)V
...
.method private send_ext(Lcom/android/internal/telephony/RILRequest;)V
    .locals 3
    .parameter "rr"
...
# virtual methods
.method public Request_Modem_Off(Landroid/os/Message;)V
    .locals 3
    .parameter "result"
...
.method public getBTADDR(Landroid/os/Message;)V
    .locals 3
    .parameter "result"
...
.method public getNVForCellon(ILandroid/os/Message;)V
    .locals 3
    .parameter "NvId"
    .parameter "result"
...
.method public getPdPConnStatus(Landroid/os/Message;)V
    .locals 3
    .parameter "result"
...
.method public getWIFIADDR(Landroid/os/Message;)V
    .locals 3
    .parameter "result"
...
.method public requestEngMode(IILandroid/os/Message;)V
    .locals 6
    .parameter "mode"
    .parameter "operation"
    .parameter "respones"
    ...
    iput-boolean v4, p0, Lcom/android/internal/telephony/RIL;->isLoopTest:Z
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/RIL;->sendScreenState_ext(Z)V
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/telephony/RIL;->sendScreenState_ext(Z)V
    ...
    .restart local v1       #rr:Lcom/android/internal/telephony/RILRequest;
    :cond_4
    const-string v2, "set modem port mode"
...
.method public resetRadio(Landroid/os/Message;)V
    ...
    const-string v4, "reset radio in type "
...
.method public responseEngMode(Landroid/os/Parcel;)Ljava/lang/Object;
    .locals 6
    .parameter "p"
    ...
    invoke-virtual {p0, v3, v4, v5}, Lcom/android/internal/telephony/RIL;->sendEngModeResult(III)V
...
.method public setNVForCellon(ILjava/lang/String;Landroid/os/Message;)V
    .locals 3
    .parameter "NvId"
    .parameter "value"
    .parameter "result"

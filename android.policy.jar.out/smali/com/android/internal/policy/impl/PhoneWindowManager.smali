...
.field private static mKeyDown:I
...
.field mLight:Landroid/os/ILightService;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyDown:I
...
.method private interceptPowerKeyDown(Z)V
    ...
    .prologue
    sget v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyDown:I
...
.method private interceptPowerKeyUp(Z)Z
    ...
    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerLongPress:Ljava/lang/Runnable;

    invoke-virtual {v2, v3}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    sput v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyDown:I
...
.method public beginLayoutLw(III)V
    ...
    const-string v5, "Portrait screen:nav bar:plugged="
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;Landroid/os/LocalPowerManager;)V
    ...
    invoke-static {v4}, Landroid/os/ILightService$Stub;->asInterface(Landroid/os/IBinder;)Landroid/os/ILightService;

    move-result-object v4

    iput-object v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLight:Landroid/os/ILightService;
...
.method initializeHdmiState()V
    ...
    .local v7, plugged:Z
    const-string v3, "/sys/devices/virtual/misc/HPD/state"

    .local v3, hdmistatename0:Ljava/lang/String;
    const-string v4, "/sys/class/misc/HPD/state"

    .local v4, hdmistatename1:Ljava/lang/String;
    const-string v5, "DEVPATH=/devices/virtual/misc/HPD"

    .local v5, hdmiueventname:Ljava/lang/String;
    new-instance v12, Ljava/io/File;

    const-string v13, "/sys/devices/virtual/misc/HPD/state"
    ...
    iget-object v12, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHDMIObserver:Landroid/os/UEventObserver;

    const-string v13, "DEVPATH=/devices/virtual/misc/HPD"

    invoke-virtual {v12, v13}, Landroid/os/UEventObserver;->startObserving(Ljava/lang/String;)V

    const-string v2, "/sys/class/misc/HPD/state"
    ...
    const-string v12, "/sys/class/misc/HPD/state"
    ...
    .local v0, buf:[C
    invoke-virtual {v9, v0}, Ljava/io/FileReader;->read([C)I
    ...
    invoke-direct {v12, v0, v13, v14}, Ljava/lang/String;-><init>([CII)V
    ...
    :goto_2
    iput-boolean v12, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHdmiPlugged:Z
    ...
    :goto_3
    invoke-virtual {p0, v10}, Lcom/android/internal/policy/impl/PhoneWindowManager;->setHdmiPlugged(Z)V
    ...
    const-string v14, "Couldn\'t read hdmi state from /sys/class/misc/HPD/state: "
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    add-long v31, v35, v37

    .local v31, timeoutTime:J
    cmp-long v35, v24, v31

    if-gez v35, :cond_1

    sub-long v35, v31, v24
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->isShowingAndNotHidden()Z
    ...
    iget-object v0, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLight:Landroid/os/ILightService;

    move-object/from16 v35, v0

    invoke-interface/range {v35 .. v35}, Landroid/os/ILightService;->turnOnButtonLightOneShot()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .local v16, homekeyAttrs:Landroid/view/WindowManager$LayoutParams;
    :goto_3
    const/4 v14, 0x0

    .local v14, homeKeyIntercept:Z
    if-eqz v16, :cond_6

    move-object/from16 v0, v16

    iget v13, v0, Landroid/view/WindowManager$LayoutParams;->homeKeyEnable:I

    .local v13, homeKeyEnable:I
    const/16 v35, 0x1
    ...
    invoke-interface/range {v29 .. v29}, Lcom/android/internal/statusbar/IStatusBarService;->cancelPreloadRecentApps()V
    :try_end_1
    ...
    .end local v14           #homeKeyIntercept:Z
    .end local v15           #homeWasLongPressed:Z
    .end local v16           #homekeyAttrs:Landroid/view/WindowManager$LayoutParams;
    :catch_0
    move-exception v10
    ...
    const-string v36, "remote call for turn on button light failed."
    ...
    .restart local v14       #homeKeyIntercept:Z
    .restart local v15       #homeWasLongPressed:Z
    .restart local v16       #homekeyAttrs:Landroid/view/WindowManager$LayoutParams;
    :catch_1
    move-exception v10
    ...
    const-string v36, "RemoteException when showing recent apps"
    ...
    invoke-interface/range {v29 .. v29}, Lcom/android/internal/statusbar/IStatusBarService;->preloadRecentApps()V
    :try_end_3
    ...
    const-string v36, "RemoteException when preloading recent apps"
